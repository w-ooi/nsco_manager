...
<div style="text-align:center;"><strong>スケジュールの更新・削除</strong></div>
<div style="text-align:center;">検索をして更新・削除を行うスケジュールを選択してください</div>
<%
...
<input type="hidden" name="page" value="updateScheduleSearch.jsp">
</form>
<br>
<form action="mfc" method="post">
<table style="margin:auto;border:1px solid;">
...
%>
		...
		<table style="margin:auto;border:1px solid;">
			...
			<tr><th colspan="2"><input type="submit" value="更新・削除する"></th></tr>
		</table>
