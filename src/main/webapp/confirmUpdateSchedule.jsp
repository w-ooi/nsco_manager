...
<div style="text-align:center;"><strong>スケジュール更新・削除の確認</strong></div>
<div style="text-align:center;">次のスケジュールを更新または削除します</div>
...
<tr><td style="width:180px;text-align:right;"><strong>中止フラグ</strong></td><td><%= schedule.getCancelFlag() %></td></tr>
<tr><th colspan="2"><input type="submit" value="スケジュール更新・削除の確定"></th></tr>
</table>
<input type="hidden" name="visit" value="confirmUpdateSchedule">
</form>
<br>
<div style="text-align:center;">
<form action="mfc" method="post">
<input type="submit" value="スケジュール更新・削除ページへ戻る">
<input type="hidden" name="visit" value="updateSchedulePage">
</form>
</div>
</body>
</html>