...
<div style="text-align:center;"><strong>スケジュール更新・削除</strong></div>
<div style="text-align:center;">更新する場合はすべての項目を入力してください</div>
<div style="text-align:center;">削除する場合は中止フラグに 1 を入力してください</div>
<%
...
<tr><td style="width:180px;text-align:right;"><strong>中止フラグ</strong></td><td><input type="text" name="cancelFlag" required value="<% if(schedule!=null){ %><%= schedule.getCancelFlag() %><% } %>"></td></tr>
<tr><th colspan="2"><input type="submit" value="スケジュール更新・削除"></th></tr>
</table>
<input type="hidden" name="visit" value="updateSchedule">
</form>
<br>
